    ...
    render() {
        ...
        <div style="max-width:760px;margin:0 auto;font-family:'DM Sans',sans-serif;color:${c.text};">
            <div style="border-radius:20px;border:1px solid ${c.borderStrong};background:${c.bg};padding:1rem;">
                ...
                <section style="margin-top:0.8rem;border-radius:14px;border:1px solid ${c.border};background:${c.panel};padding:0.75rem;">
                ...
                <section style="margin-top:0.8rem;border-radius:14px;border:1px solid ${c.dangerBorder};background:${c.dangerBg};padding:0.75rem;">
